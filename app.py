...
def home(): 
 return f""" 
 <html><head><meta charset="utf-8"><title>Flask PaaS Demo</title>  <style> 
 body {{ font-family: Arial; max-width: 640px; margin: 60px auto; }}  .box {{ background:#DEEAF1; border-left: 5px solid #1F4E79; 
 ...
 <p>Developer chi viet code – PaaS lo build, deploy, HTTPS, scaling!</p>  </body></html> 
 """ 
@app.route("/health") 
def health(): 
 return {"status": "ok"} 
